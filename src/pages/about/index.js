...
import picture7 from "../../assets/images/OpenCV_Computer_Vision.png";
            ...
            <div className="content-container">
              ...
              <div className="content">
                <div className="text-content">
                  <p className="intro-2">
                    <p className="Background">Background:</p>I am a motivated
                    graduate student in Computer Science at Northeastern
                    University, known for my passion for learning and ability to
                    quickly acquire new skills. I excel at prioritizing and
                    completing tasks, a skill that has been honed through my
                    academic journey and work experience.<br></br> <br></br>I
                    hold a bachelor's degree in Mechanical Engineering from the
                    University of Rhode Island. My professional background
                    includes an internship in the Computer Numerical Control
                    (CNC) industry, where I worked as a Mechanical/Manufacturing
                    Engineer Intern. This experience highlighted the impact of
                    computer software programming on productivity across various
                    domains. Inspired by this, I pursued a field of study in
                    Computer Science to enhance my skills and experiences,
                    aiming to apply them effectively in my future career.
                  </p>
                </div>
              ...
              <div className="ad experience">
                ...
                <div className="additional-experience px-2">
                  <p>
                    Beyond my academic and professional achievements, I have
                    cultivated a robust expertise in multimedia production and
                    content creation. This includes:
                  </p>
                  <ul>
                    <li>
                      <strong>Computer Vision Application:</strong>{" "}
                      <span className="description_1">
                        (Image Filtering, Pattern Recognition, Data Analysis)
                      </span>{" "}
                      <br></br>
                      Developed a real-time video processing application using
                      OpenCV,Implemented a content-based image retrieval system
                      with custom C++ and Python scripts, featuring histogram
                      analysis, color segmentation, and deep learning embeddings
                      for nuanced image comparison.
                    </li>
                    <br></br>
                    <li>
                      ...
                      <span className="description_1">
                        {" "}
                        (NEU Project Search Website - Collab)
                      </span>{" "}
                      <br></br>
                      Designed and developed a full-stack website with React and
                      MongoDB. Integrated Figma mockups, implemented CRUD
                      operations, and tailored user access controls for project
                      management and profile customization.
                    </li>
                    <br></br>
                    <li>
                      ...
                      <br></br>Crafted a Figma-based UI/UX design for a travel
                      planning app, focusing on user experience with a clean
                      layout for search, booking, and user profiles. Prioritized
                      intuitive navigation and aesthetic appeal to streamline
                      travel planning.
                    </li>
                    <br></br>
                    <li>
                      <strong>Photography & Video Shooting:</strong>{" "}
                      <span className="description_1">
                        {" "}
                        (Commercial production, Wedding, Event Videographer,
                        Portrait){" "}
                      </span>{" "}
                      <br></br>Active in freelance projects, combine technical
                      acumen with artistic creativity to produce visually
                      captivating content, ranging from commercial videography
                    ...
                    <li>
                      ...
                      <span className="description_1">
                        {" "}
                        (Digital Creator - After Effect Production){" "}
                      </span>{" "}
                      <br></br> Advanced proficiency in{" "}
                      <strong>Davinci Resolve</strong> for comprehensive video
                      editing, color grading, and visual effects using its
                      Fusion feature. Adept in <strong>Adobe Photoshop</strong>{" "}
                      and <strong>Lightroom</strong> for high-end graphic design
                      and photo editing, contributing to enhanced visual
                ...
                <div className="media-showcase">
                  <div className="col-md-10 photo-showcase">
                    <h1 className="description-1 text-center py-4">
                      ...
                      <a
                        href="https://github.com/FRFRANk-1/CS5330_HW_2/blob/CS5330_Project_2/readme.md"
                        className="website-link"
                      >
                        <div className="image-group">
                          <img
                            src={picture7}
                            className="picture7 img-fluid hover-effect"
                    ...
                    <a
                      href="https://neu-colab.netlify.app/"
                    ...
                    <div className="col-md-12 uiux-showcase">
                      <h1 className="description-3 text-center py-4">
                        UI/UX Design:
                      </h1>
            ...
            <br></br> */}
                ...
                />
                      ...
                      <a
                        ...
                        className="video-link_wedding"
                      >
                        <h4 className="video-descrip py-4">
                          Boston Wedding, Cambridge 2024
                        </h4>
                      </a>
